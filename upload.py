...
def mappingFromListToDict(interested: list) -> dict:
    ...
    try:
        ...
        print(f"\033[1;31mERROR IN MAPPING: {e}\033[0m")
        return {}
...
class P2PUploader:
    ...
    def start(self):
        try:
            ...
            print(f"\033[1;31mERROR IN START: {e}\033[0m")
...
#                         print(f"\033[1;31mERROR IN HANDLE CLIENT SEND PIECE EMPTY: {e}\033[0m")
                ...
                try:
                    ...
                    print(f"\033[1;31mERROR IN READ STATUS (UPLOAD): {e}\033[0m")
        except Exception as e:
            print(f"\033[1;31mERROR IN HANDLE CLIENT: {e}\033[0m")
        finally:
            client_socket.close()
            try:
                ...
                print(f"\033[1;31mERROR IN HANDLE CLIENT REMOVE: {e}\033[0m")
    ...
    def stop(self):
        ...
        try:
            ...
            print(f"\033[1;31mERROR IN STOP: {e}\033[0m")
    ...
    def reEvaluteTopPeersBody(self):
        ...
        try:
            ...
            print(f"\033[1;31mERROR IN REEVALUTE BODY: {e}\033[0m")
    ...
    def reEvaluteTopPeers(self):
        try:
            ...
            print(f"\033[1;31mERROR IN REEVALUTE: {e}\033[0m")
    ...
    def optimisticallyUnchokeBody(self):
        ...
        try:
            ...
            print(f"\033[1;31mERROR IN OPTIMISTICALLY BODY: {e}\033[0m")
    ...
    def optimisticallyUnchoke(self):
        try:
            ...
            print(f"\033[1;31mERROR IN OPTIMISTICALLY: {e}\033[0m")
